...
public class CardDataBase : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		cardList.Add(new Card(1, "Nain", 1, 5, 3, "Attention à ma grosse hache", Resources.Load<Sprite>("1"), 2, 3));
		cardList.Add(new Card(2, "Elfe", 1, 5, 3, "Je tire à l'arc !", Resources.Load<Sprite>("2"), 3, 2));
		cardList.Add(new Card(3, "Orc", 1, 5, 3, "Rrrrrr !", Resources.Load<Sprite>("1"), 0, 5));
		...
		cardList.Add(new Card(6, "Radluir double-hache", 3, 3, 3, "", Resources.Load<Sprite>("4"), 1, 3));
